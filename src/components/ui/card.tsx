...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className, title, mode = 'default', children, ...props }, ref) => {
    ...
    return (
      ...
      >
        {titleElement}
        <section className="block pt-[calc(var(--theme-line-height-base)*0.5rem)] px-8 pb-[calc(var(--theme-line-height-base)*1rem)] overflow-visible shadow-[inset_2px_0_0_0_var(--theme-text),inset_-2px_0_0_0_var(--theme-text),inset_0_-2px_0_0_var(--theme-text)]">
          {children}
        </section>
      </article>
    )
...
const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('flex items-end justify-between', className)} {...props} />
  ),
)
...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn('flex-shrink-0 px-4 text-base font-bold', className)} {...props} />
  ),
)
...
const CardLeftSection = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
...
const CardLeftCorner = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
...
const CardRightSection = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
...
const CardRightCorner = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
